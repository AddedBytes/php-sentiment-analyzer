...
class Config
{
    ...
    public const float B_INCR = 0.293;
    public const float B_DECR = -0.293;

    // (empirically derived mean sentiment intensity rating increase for using
    // ALLCAPs to emphasize a word)
    public const float C_INCR = 0.733;

    public const float N_SCALAR = -0.74;
    // for removing punctuation
    //const REGEX_REMOVE_PUNCTUATION = re.compile('[%s]' % re.escape(string.punctuation))

    public const array NEGATE = ["aint", "arent", "cannot", "cant", "couldnt", "darent", "didnt", "doesnt",
    ...
    public const array BOOSTER_DICT = ["absolutely" => self::B_INCR, "amazingly" => self::B_INCR, "awfully" => self::B_INCR, "completely" => self::B_INCR, "considerably" => self::B_INCR,
    ...
    public const array SENTIMENT_LADEN_IDIOMS = ["cut the mustard" => 2, "hand to mouth" => -2,
    ...
    public const array SPECIAL_CASE_IDIOMS = ["the shit" => 3, "the bomb" => 3, "bad ass" => 1.5, "bus stop" => 0.0, "yeah right" => -2, "cut the mustard" => 2, "kiss of death" => -1.5, "hand to mouth" => -2, "beating heart" => 3.1, "broken heart" => -2.9, "to die for" => 3];
    ##Static methods##
    ...
    */
    public static function normalize($score, $alpha = 15): float|int
    {
